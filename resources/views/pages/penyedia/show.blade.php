...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h4 class="m-0">Daftar Penyedia</h4>
                <ol class="breadcrumb">
...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" action="{{ route('penyedia.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="penyedia" class="col-form-label">Nama Penyedia:</label>
...
<div class="modal fade" id="editModal" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModal">Edit Penyedia</h5>

                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formUpdate" action="{{ route('penyedia.update', $row->id_penyedia) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="penyedia" class="col-form-label">Nama Penyedia:</label>
                        <input type="text" class="form-control" id="penyedia" name="penyedia" value="{{ $row->nama_penyedia }}" required>
                    </div>
                    <div class="mb-3">
                        <label class="col-form-label">Status:</label>
                        <div class="input-group">
