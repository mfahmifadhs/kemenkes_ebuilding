    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('dist/img/logo-ebuilding.png') }}" alt="Sistem Informasi Pergudangan" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar mt-3">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-header"><i>Penilaian</i></li>
                        @if (!in_array(Auth::user()->role_id, [5, 4]))
                        <li class="nav-item">
                            <a href="{{ route('kriteria') }}" class="nav-link font-weight-bold">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ Route('temuan') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Temuan</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('penyedia') }}" class="nav-link font-weight-bold">
                        ...
                        <li class="nav-header"><i>Pengguna</i></li>
                        <li class="nav-item">
                            <a href="{{ route('user') }}" class="nav-link font-weight-bold">
